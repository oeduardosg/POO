...
public class TestadorQ1 {
	...
	public static void main(String[] args) {
		...
		Funcionario barbara = new Funcionario("barbara", 13000);
		robux.addFuncionario(barbara);

		Funcionario aline = new Funcionario("aline", 12500);
		minecraftUpdates.addFuncionario(aline);

		System.out.println("Imprimindo funcionarios do departamento " + roblox.getNome());
		System.out.println(roblox.getFuncionarios());
		System.out.println(); // blanc line
		System.out.println("Imprimindo funcionarios do departamento " + minecraft.getNome());
		System.out.println(minecraft.getFuncionarios());

		System.out.println("\nAlterando o setor de um funcionario");
		minecraftUpdates.addFuncionario(barbara);
		System.out.println("Imprimindo funcionarios do departamento " + minecraft.getNome());
		System.out.println(minecraft.getFuncionarios());
	}
